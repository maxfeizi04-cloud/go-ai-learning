...
type Config struct {
	...
	EmbeddingBaseURL string  // 嵌入 API 地址（Ollama 本地部署）
}
...
func Load() *Config {
	return &Config{
		...
		EmbeddingModel:   getEnv("DEEPSEEK_EMBEDDING_MODEL", "nomic-embed-text"),
		EmbeddingBaseURL: getEnv("DEEPSEEK_EMBEDDING_BASE_URL", "http://localhost:11434"),
	}
}
